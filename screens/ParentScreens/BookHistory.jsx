  ...
  const fetchLibraryBooks = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASEURL}/api/library/request-book/?page=${currentPage}&user_id=${appUser.id}&status=issued`,
        {
          method: 'GET',
          headers: {
  ...
  const submitBookRequest = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASEURL}/api/library/request-book/`,
        payload,
        {
          method: 'POST',
          headers: {
      ...
      // console.log(
      //   "Url :",
      //   `${BASEURL}/api/library/books/?branch_id=${appUser.branch_id}`,
      // );
      // console.log("Token :", token);
      ...
      // console.log("Error while request submit : ", e);
    ...
    >
      <View style={styles.cardContent}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.rollNumber}>{item.due_date}</Text>
          <View style={styles.detailsRow}>
            <Text style={styles.classroom}>{item.status}</Text>
          </View>
        </View>
      </View>
    </TouchableOpacity>
...
const RequestedBooksList = () => {
  ...
  const fetchLibraryBooks = async () => {
    ...
    try {
      ...
      setLoadingBooks(true);
      const response = await axios.get(
        `${BASEURL}/api/library/request-book/?page=${currentPage}&user_id=${appUser.id}&status=returned`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
...
const BookHistory = () => {
  ...
  const tabs = ['Books In-Hand', 'Book History'];
